...
<head>
    <meta charset="utf-8">
    <title>New Record for <?php echo $row["FirstName"]; ?> <?php echo $row["LastName"]; ?></title>
    ...
    <div class="container my-5">
        ...
        <div class="wholeform">
            <form id="PatientInfo" name="PatientInfo" action="process.php" method="post" class="row g-3 needs-validation" novalidate>
                <h1>Channeling for <?php echo $row["FirstName"]; ?> <?php echo $row["LastName"]; ?></h1>
                ...
                <div class="name" style="display: none;">
                    ...
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control pname" name="firstname" placeholder="Enter Your First Name" id="validationCustom01" value="<?php echo $row["FirstName"]; ?>" required>
                    ...
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control pname" name="lastname" placeholder="Enter Your Last Name" id="validationCustom02" value="<?php echo $row["LastName"]; ?>" required>
